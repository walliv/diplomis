\chapter{SPDK Framework configuration}
\label{chap:spdk_conf}
The framework can be downloaded from the fork of its GitHub repository (cite this) and switching
to branch XXX.

\chapter{DMA Iuventus register map}
\label{chap:iuventus_reg_map}

The complete list of registers that are initalized in the \emph{Software manager} component is
