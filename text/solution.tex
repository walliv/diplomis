...
\ac{PCIe} domain. The standard emerged as a successor of \emph{SAS} and \emph{SATA} specifications
in order to meet the requirements of consumer systems in terms of latency, throughput and
scalability that fits with the flash-based storage. 
