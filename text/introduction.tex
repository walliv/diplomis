...
permanent storage, additional software overhead in case the CPU needs to copy the data itselv, and
...
From the hardware perspective, the thesis begins in \cref{chap:pcie_express}, where the PCIe
...
sector-level tests. The selected \emph{exFAT} filesystem provides a simple and portable target for
validating the correctness of read/write operations across CPU and accelerator accesses.
